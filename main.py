...
class Application:
    ...
    def __init__(self):
        ...
        self.ct['blank'] = 0
        self.blank_flag = 0
        self.space_flag=False #to control the state of application
        self.next_flag=True
        self.prev_char=""
        self.count=-1
        self.ten_prev_char=[]
        ...
        self.root = tk.Tk()
        self.root.title("Hand Gestures Detection")
        self.root.protocol('WM_DELETE_WINDOW', self.destructor)
        self.root.geometry("1300x700") #set the size of window

        self.panel = tk.Label(self.root) #Creates a label widget to display the video feed and places it at the specified position (x=100, y=3) with the specified width and height.
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\sharath R\\OneDrive\Desktop\\sign language to text and speech coversion\\white .jpg.jpg")
    ...
    def distance(self,x,y):
        return math.sqrt(((x[0] - y[0]) ** 2) + ((x[1] - y[1]) ** 2)) #Euclidean distance between two points x and y.

    def action1(self):#Button Actions
    ...
    def speak_fun(self):#Text-to-Speech
        self.speak_engine.say(self.str)
        self.speak_engine.runAndWait()


    def clear_fun(self):#Clear Function
        self.str=" "
        self.word1 = " "
        self.word2 = " "
        self.word3 = " "
    ...
    def predict(self, test_image):#prediction method
        white=test_image
